...
type Props = { gasEth: number };

export default function TreatmentCosts({ gasEth = 0 }: Props) {
  const items = [
    { title: "Co-Pay Rookie",     desc: "≥ 0.005 ETH", ok: gasEth >= 0.005 },
    { title: "Co-Pay Novice",     desc: "≥ 0.01 ETH",  ok: gasEth >= 0.01 },
    { title: "Co-Pay Enthusiast", desc: "≥ 0.05 ETH",  ok: gasEth >= 0.05 },
    { title: "Co-Pay Pro",        desc: "≥ 0.1 ETH",   ok: gasEth >= 0.1 },
    { title: "Co-Pay Legend",     desc: "≥ 0.5 ETH",   ok: gasEth >= 0.5 },
    { title: "Co-Pay Whale",      desc: "≥ 1 ETH",     ok: gasEth >= 1 },
  ];
  ...
  return (
    <section className="rounded-2xl border border-white/10 bg-black/20 overflow-hidden h-full flex flex-col">
      ...
      <div className="px-5 py-4 border-b border-white/10 flex items-center justify-between">
        <div className="text-[15px] font-semibold">Treatment Costs</div>
        <div className="text-sm opacity-70">Gas: {gasEth.toFixed(4)} ETH</div>
      </div>
