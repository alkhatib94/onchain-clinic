...
export default function CheckupFrequency({ activeDays = 0 }: Props) {
  const items = [
    { title: "Clinic Visitor I", desc: "≥ 10 active days", ok: activeDays >= 10 },
    { title: "Clinic Visitor II", desc: "≥ 20 active days", ok: activeDays >= 20 },
    { title: "Clinic Visitor III", desc: "≥ 30 active days", ok: activeDays >= 30 },
    { title: "Clinic Visitor IV", desc: "≥ 50 active days", ok: activeDays >= 50 },
    { title: "Clinic Visitor V", desc: "≥ 100 active days", ok: activeDays >= 100 },
    { title: "Clinic Visitor VI", desc: "≥ 200 active days", ok: activeDays >= 200 },
  ];
  ...
  return (
    <section className="rounded-2xl border border-white/10 bg-black/20 overflow-hidden h-full flex flex-col">
      ...
      <div className="px-5 py-4 border-b border-white/10 flex items-center justify-between">
        <div className="text-[15px] font-semibold">Checkup Frequency</div>
        <div className="text-sm opacity-70">Days: {activeDays}</div>
      </div>
